...
contract BasicVerificationGame is IDisputeResolutionLayer {
    ...
    function performStepVerification(
        ...
        require(checkProofOrdered(proof, game.programMerkleRoot, keccak256(highStepState), game.highStep));

        bytes32 newState = game.vm.runStep(lowStepState, nextInstruction);
